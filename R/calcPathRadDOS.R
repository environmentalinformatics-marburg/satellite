...
#'
#' @param DNmin digital number of dark object in band bnbr (e.g. minimum raw count of selected
#' raster band bnbr)
...
#' @param radm Band-specific mulitplicative rescaling factor from the metadata
#' (RADIANCE_MULT_BAND_x, where x is the band number).
#' @param rada Band-specific additive rescaling factor from the metadata
...
#' 
#' For Landsat band_wls, radm, rada and szen can easily be retrieved from respective colums of
#' a data frame generated by the \code{\link{compMetaLandsat}} function.
#' 
